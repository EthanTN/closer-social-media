...
class Post{
       ...
       if($check_empty != ""){
            ...
            foreach($body_array as $key => $value){
                if(strpos($value, "www.youtube.com/watch?v=") !== false){
                    ...
                    $value = "<br><iframe width=\'420\' height:\'400\' src=\'".$value."\'></iframe><br>";
    ...
    public function loadPostsFriends($data, $limit){
        ...
        if(mysqli_num_rows($data_query) > 0){
            ...
            while ($row = mysqli_fetch_array($data_query)){
                ...
                //Prepare user_to string so it can be included even if not posted
                if($row['user_to'] == 'none'){
                    $user_to = "";
                }
                else{
                ...
                if($user_logged_obj->isFriend($added_by)){
                    ...
                    if($userLoggedIn == $added_by){
                        $delete_button = "<button class='delete_button danger' id='post$id'>Delete</button>";
                    }else{
                        $delete_button = "";
                    }
                ...
                <script>
                    $(document).ready(function() {
                        $('#post<?php echo $id; ?>').on('click', function() {
                            bootbox.confirm("Are you sure you want to remove this post?", function(result) {
    ...
    public function getSinglePost($post_id){
        ...
        if(mysqli_num_rows($data_query) > 0){
            ...
            echo "No post found. If you clicked a link, it maybe broken";
            return;
        }
        echo $str; 
    }
